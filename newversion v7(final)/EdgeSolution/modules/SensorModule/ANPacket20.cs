...
namespace Sensor_Reading
{
    class ANPacket20
    {
        ...
        public Boolean dualAntennaHeadingActive = false;
        ...
        public ANPacket20(ANPacket packet)
        {
            ...
            if ((packet.data[3] & 0x04) != 0) dualAntennaHeadingActive = true;
            ...
            time = new DateTime(1970, 1, 1) + TimeSpan.FromSeconds(utc_time) + TimeSpan.FromTicks(microseconds * 10);
